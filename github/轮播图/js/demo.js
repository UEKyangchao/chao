/*
* @Author: yangchao
* @Date:   2017-08-14 14:08:27
* @Last Modified by:   yangchao
* @Last Modified time: 2017-08-15 08:54:52
*/
...
// 		}else if (/^[a-zA-Z][a-zA-Z]{0,8}$/){
// 			retern ranger.getElementsByTagName(selector)
// 		}
...
//    	{
//    	collection[i][style]=fn
//    }
// }
// function off(collection,type){
//    	for (let i=0;i<collection.length;i++)
//    	{
//     collection[i][style]=null
//    }
// }
// 
window.onload = function(){ 
